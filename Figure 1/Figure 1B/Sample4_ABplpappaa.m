% Kidney Cell:asymmetric division
clear all;clc;close all;

Mothername='ABplpappaa';
dau1name=[Mothername,'a'];
dau2name=[Mothername,'p'];
...
ColorMother=ColorTree{MRow,MColumn}+[0.11,0,0];
Colordau1=ColorTree{D1Row,D1Column}+[0.07,-0.1,-0.1];
Colordau2=ColorTree{D2Row,D2Column}+[0.15,0.1,0.1];
