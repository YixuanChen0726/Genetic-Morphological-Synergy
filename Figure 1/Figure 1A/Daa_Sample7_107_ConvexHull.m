...
[SurfaceAxis0,~]=convhull(CellAxis,'simplify',true);

% convex hull
close all;clc;
figure(1)
h=trisurf(SurfaceAxis,CellAxis(:,1),CellAxis(:,2),CellAxis(:,3),'EdgeColor','none','FaceColor',Color1,'FaceAlpha',1);hold on;
h0=trisurf(SurfaceAxis0,CellAxis(:,1),CellAxis(:,2),CellAxis(:,3),'EdgeColor',Color2,'LineWidth',0.8,'FaceColor',Color1,'FaceAlpha',0.3);hold on;
