% Conduct significance analysis on all shapes of partail cells
clear all;clc;
...
[Temp1,Temp2,meanData,p,asym]=SigniFun(GSphTree,LineageTree,CapaVen,CappDor);
ShapeSigni(2:end,1)={Temp1;Temp2;meanData;p;asym};
[Temp1,Temp2,meanData,p,asym]=SigniFun(DSphTree,LineageTree,CapaVen,CappDor);
ShapeSigni(2:end,2)={Temp1;Temp2;meanData;p;asym};
[Temp1,Temp2,meanData,p,asym]=SigniFun(ISphTree,LineageTree,CapaVen,CappDor);
ShapeSigni(2:end,3)={Temp1;Temp2;meanData;p;asym};
[Temp1,Temp2,meanData,p,asym]=SigniFun(MPSphTree,LineageTree,CapaVen,CappDor);
ShapeSigni(2:end,4)={Temp1;Temp2;meanData;p;asym};
[Temp1,Temp2,meanData,p,asym]=SigniFun(HRoundTree,LineageTree,CapaVen,CappDor);
ShapeSigni(2:end,5)={Temp1;Temp2;meanData;p;asym};
[Temp1,Temp2,meanData,p,asym]=SigniFun(SpreadTree,LineageTree,CapaVen,CappDor);
ShapeSigni(2:end,6)={Temp1;Temp2;meanData;p;asym};
[Temp1,Temp2,meanData,p,asym]=SigniFun(ElonTree,LineageTree,CapaVen,CappDor);
ShapeSigni(2:end,7)={Temp1;Temp2;meanData;p;asym};
[Temp1,Temp2,meanData,p,asym]=SigniFun(PivoTree,LineageTree,CapaVen,CappDor);
ShapeSigni(2:end,8)={Temp1;Temp2;meanData;p;asym};
[Temp1,Temp2,meanData,p,asym]=SigniFun(HFlatTree,LineageTree,CapaVen,CappDor);
ShapeSigni(2:end,9)={Temp1;Temp2;meanData;p;asym};
[Temp1,Temp2,meanData,p,asym]=SigniFun(WFlatTree,LineageTree,CapaVen,CappDor);
ShapeSigni(2:end,10)={Temp1;Temp2;meanData;p;asym};
[Temp1,Temp2,meanData,p,asym]=SigniFun(HuangTree,LineageTree,CapaVen,CappDor);
ShapeSigni(2:end,11)={Temp1;Temp2;meanData;p;asym};
[Temp1,Temp2,meanData,p,asym]=SigniFun(CoreyTree,LineageTree,CapaVen,CappDor);
ShapeSigni(2:end,12)={Temp1;Temp2;meanData;p;asym};

save(['Cap_partial_shapesig.mat'],'ShapeSigni','-v7.3');
