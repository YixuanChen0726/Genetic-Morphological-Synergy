...
viewangle=[-23,25;166,70;110,90;-11,52;-87,38];
for Num=1:5
    figure(Num)
    ...
    print(gcf,['.\Sample',num2str(SampleNum),'_',CellName,'_Frame_',num2str(Frame,'%03d'),'_WFlatigh',num2str(Num)],'-dpng','-r600');
end

viewangle=[284,23;-66,82;53,70;-43,7;271,53];
for Num=1:5
    figure(Num+5)
