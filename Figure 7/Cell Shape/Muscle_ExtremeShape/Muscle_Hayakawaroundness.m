...
viewangle=[-83,14;-79,-7;-40,-14;-36,13;165,19];
for Num=1:5
    figure(Num)
    ...
    load(['..\..\..\bin\CMap DataWT_Sample',num2str(SampleNum),'_AllSpace.mat']);
...
viewangle=[135,32;-91,-52;-8,7;144,-1;-89,4];
for Num=1:5
    figure(Num+5)
