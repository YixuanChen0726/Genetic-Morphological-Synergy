...
viewangle=[-28,29;-19,11;58,11;0,21;148,-77];
for Num=1:5
    figure(Num)
    WFlatigh=HighData(Num,:);
    SampleNum=WFlatigh{1,1};CellName=WFlatigh{1,2};Frame=WFlatigh{1,3};
...
viewangle=[94,-26;-134,-6;-108,10;33,22;80,-1];
for Num=1:5
    figure(Num+5)
