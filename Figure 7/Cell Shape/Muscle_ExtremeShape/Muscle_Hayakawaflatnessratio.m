% Muscle: Hayakawa Flatness Ratio
...
viewangle=[16,4;21,7;9,23;-77,29;81,-5];
for Num=1:5
    figure(Num)
    HFlatigh=HighData(Num,:);
    SampleNum=HFlatigh{1,1};CellName=HFlatigh{1,2};Frame=HFlatigh{1,3};
...
viewangle=[137,3;-16,11;-189,-17;138,2;44,2];
for Num=1:5
    figure(Num+5)
